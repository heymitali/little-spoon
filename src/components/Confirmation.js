    ...
    <div className="justify-center mt-20">
      ...
      <div className="flex justify-center">
        <button
          ...
          onClick={handleClick}
        >
          <span className="relative w-32 h-auto px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-white dark:text-blue-500 rounded-3xl group-hover:bg-opacity-0 hover:text-white">
            Go Home
          </span>
        </button>
      </div>
